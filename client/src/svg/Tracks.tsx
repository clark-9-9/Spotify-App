...
const unLikedHeart = (className: string, style?: Styles) => (
    <svg className={className} style={style} role="img" height="32" width="32" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon" >
...
const likedHeart = (className: string, style?: Styles) => (
    <svg className={className} style={style} role="img" height="32" width="32" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon" >
