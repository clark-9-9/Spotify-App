...
const home = (className: string, style?: object) => (
...
const homeFilled = (className: string, style?: object) => (
    <svg role="img" height="24" width="24" aria-hidden="true" style={style} className={className} viewBox="0 0 24 24" data-encore-id="icon">
...
const search = (className: string, style?: object) => (
    <svg role="img" height="24" width="24" aria-hidden="true" style={style} className={className} viewBox="0 0 24 24" data-encore-id="icon">
...
const searchFilled = (className: string, style?: object) => (
    <svg role="img" height="24" width="24" aria-hidden="true" style={style} className={className} viewBox="0 0 24 24" data-encore-id="icon">
